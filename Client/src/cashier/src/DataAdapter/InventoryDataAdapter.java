...
import cashier.src.Model.Inventory;
...
import static cashier.src.DataAdapter.ProductDataAdapter.getProductQuantity;
import static cashier.src.DataAdapter.ProductDataAdapter.updateProductQuantity;
...
public class InventoryDataAdapter {
    ...
    public static List<Inventory> getAllInventory() {
        ...
        try {
            ...
            URL url = new URL("http://localhost:8017/inventory"); // Replace with your endpoint
    ...
    public static void addInventory(int productID, int quantityReceived, String date, int supplierID) {
        try {
            ...
            URL url = new URL("http://localhost:8017/inventory");
            ...
            if (responseCode == HttpURLConnection.HTTP_CREATED) {
                ...
                int old_quantity = (int) getProductQuantity(productID);
                updateProductQuantity(productID, old_quantity + quantityReceived);
            } else {
