...
public class InventoryDataAdapter {
    ...
    private static final String INVENTORY_URL = "http://localhost:8017/inventory"; // URL for your inventory endpoint
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                    ...
                    List<Object> rawJsonList = gson.fromJson(response.toString(), new TypeToken<List<Object>>() {}.getType());
